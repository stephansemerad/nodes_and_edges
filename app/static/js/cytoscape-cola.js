(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else root["cytoscapeCola"] = factory(root["webcola"]);
    ...
    /******/ [
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var cola =
          ...
          (typeof window !== "undefined" ? window.cola : null);
        ...
        var isNumber = function isNumber(o) {
          return (
            (typeof o === "undefined" ? "undefined" : _typeof(o)) === _typeof(0)
          );
        };
        ...
        ColaLayout.prototype.run = function () {
          ...
          nodes.on(
            "grab free position",
            (grabHandler = function grabHandler(e) {
              var node = this;
          ...
          nodes.on(
            "lock unlock",
            (lockHandler = function lockHandler() {
              var node = this;
              var scrCola = node.scratch().cola;
          ...
          adaptor.links(
            edges
              .stdFilter(function (edge) {
                return (
                  nonparentNodes.contains(edge.source()) &&
                  nonparentNodes.contains(edge.target())
                );
              })
              .map(function (edge) {
